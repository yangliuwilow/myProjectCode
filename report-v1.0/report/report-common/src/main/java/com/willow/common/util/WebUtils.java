...
public abstract class WebUtils {
    ...
    private static HttpURLConnection getConnection(URL url, String method, String ctype, Map<String, String> headerMap) throws IOException {
        ...
        conn.setRequestProperty("Accept", "text/xml,text/javascript,text/html;q=0.9,*/*;q=0.8");
        conn.setRequestProperty("User-Agent", "reapal-sdk-java");
    ...
    public static void main(String[] args) {
        try {
            Map map = new HashMap();
            map.put("merchant_id", "23423432w");
            System.out.println(WebUtils.doPost("https://payment.kklpay.com/ebank/server/callback.do", new HashMap(), 30000, 30000));
        } catch (IOException e) {
